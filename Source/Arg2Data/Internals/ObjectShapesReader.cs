...
namespace Arg2Data.Internals
{
    internal static class ObjectShapesReader
    {
        ...
        {
            shapeData.Offset1 = BitConverter.ToInt16(new[] { data[4], data[5] }, 0);
            shapeData.Offset2 = BitConverter.ToInt16(new[] { data[8], data[9] }, 0);
            shapeData.Offset3 = BitConverter.ToInt16(new[] { data[12], data[13] }, 0);
            shapeData.Offset4 = BitConverter.ToInt16(new[] { data[16], data[17] }, 0);
            shapeData.Offset5 = BitConverter.ToInt16(new[] { data[20], data[21] }, 0);
            shapeData.Offset6 = BitConverter.ToInt16(new[] { data[24], data[25] }, 0);
            shapeData.Offset7 = BitConverter.ToInt16(new[] { data[28], data[29] }, 0);
