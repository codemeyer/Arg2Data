...
namespace Arg2Data.Tests.Internals
{
    public class BestLineReaderFacts
    {
        ...
        public void MontrealBestLine()
        {
            ...
            var bestLines = BestLineReader.Read(trackData.Path, trackData.KnownBestLineSectionDataStart);
            ...
            var firstSegment = bestLines.BestLineSegments[0];
            ...
            var segment2 = bestLines.BestLineSegments[1];
            segment2.Length.Should().Be(37);
            segment2.Radius.Should().Be(0);

            var segment3 = bestLines.BestLineSegments[2];
            segment3.Correction.Should().Be(185);

            var segment6 = bestLines.BestLineSegments[5];
            ...
            var lastSegment = bestLines.BestLineSegments.Last();
